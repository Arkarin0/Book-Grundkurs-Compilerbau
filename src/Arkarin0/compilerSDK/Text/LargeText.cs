...
using Arkarin0.CodeAnalysis.PooledObjects;
...
namespace Arkarin0.CodeAnalysis.Text
{
    ...
    public sealed class LargeText : SourceText
    {
        ...
        /// </remarks>
        internal const int ChunkSize = SourceTextExtensions.LargeObjectHeapLimitInChars; // 40K Unicode chars is 80KB which is less than the large object heap limit.
