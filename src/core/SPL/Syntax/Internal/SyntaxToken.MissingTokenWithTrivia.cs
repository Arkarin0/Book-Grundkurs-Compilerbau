...
namespace BGC.CodeAnalysis.SPL.Syntax.InternalSyntax
{
    internal partial class SyntaxToken
    {
        ...
        {
            internal MissingTokenWithTrivia(SyntaxKind kind)
            : base(kind,null)
            {
                this.flags &= ~NodeFlags.IsNotMissing;
            }

            internal MissingTokenWithTrivia(SyntaxKind kind, DiagnosticInfo[] diagnostics)
            ...
            public override GreenNode SetDiagnostics(DiagnosticInfo[] diagnostics)
            {
                ...
                return new MissingTokenWithTrivia(this.Kind, diagnostics);
            }
